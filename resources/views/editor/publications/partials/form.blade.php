...
<h1 class="text-2xl font-bold mt-8 mb-2">Imagen del libro</h1>

<div class="grid grid-cols-2 gap-4">
    <figure>
        @isset($publication->image)
             <img id="picture" class="w-full h-64 object-cover object-center" src="{{Storage::url($publication->image->url)}}" alt="">
         @else
    ...
    <div>
        <p class="mb-2 text-justify">Carga la imagen de tu libro aquí. Para ser aceptada, debe cumplir nuestros estándares de calidad para las imágenes de los libros. Directrices importantes: 750 x 422 pixeles; formato .jpg, .jpeg, .gif o .png; y sin texto en la imagen.</p>
...
<div class="grid grid-cols-2 gap-4">
    ...
    <div>
        <p class="mb-2 text-justify">Carga el recurso pdf de tu publicación aquí. Para ser aceptada, debe cumplir nuestros estándares de calidad  Directrices importantes: formato pdf.</p>
