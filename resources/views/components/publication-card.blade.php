...
<div class="flex flex-col items-center justify-center h-full">{{-- tarjeta que muestra informacion del producto --}}
    ...
    <article
        class="p-2 transition-all duration-500 transform shadow-xl w- rounded-xl hover:shadow-2xl hover:scale-105 flex flex-col object-center bg-contain w-64 h-64 rounded-t-md"
