    ...
    <div class="container flex py-4 mt-2 mb-16 bg-gray-400 shadow-lg">
        <div class="grid px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 sm:grid-cols-2 md:grid-cols-3 gap-x-2 gap-y-2">
            ...
            <div class="relative" x-data="{open: false}">
                    ...
                    <button class="block h-12 px-4 overflow-hidden w-full text-white bg-blue-500 rounded-lg shadow focus:outline-none hover:bg-blue-700" x-on:click="open = true">
