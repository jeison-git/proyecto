                    ...
                    <table role="presentation"
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                ...
                                <p style="margin:0;margin-bottom:8px;text-align:justify;">Queremos hacerle saber que su curso <a style="color:#75e50d;text-decoration:underline;">{{ $course->title }}</a>, ha sido revisado minuciosamente y este ha cumplido con los estandares de cálidad, estamos muy agradecidos con su participacion en esta iniciativa.</p>
                            </td>
                        </tr>
